export const SEO_CONFIG = {
    ...
    siteUrl: "https://pushpako2.com", // Hardcoded for production SEO consistency
    keywords: [
...
export const generateMetadata = (pageConfig) => {
    ...
    const cleanPath = (pageConfig.path || "").replace(/^\//, '');
    const url = `${SEO_CONFIG.siteUrl}/${cleanPath}`;
    ...
    return {
        ...
        openGraph: {
            ...
            images: [
                {
                    url: pageConfig.image || '/og-image.jpg',
                    width: 1200,
                    height: 630,
                    alt: baseTitle,
                }
